...
LICENSE_NAME="${LICENSE_NAME:-"HT"}"
LICENSE_COMPANY="${LICENSE_COMPANY:-"HT"}"
LICENSE_EMAIL="${LICENSE_EMAIL:-"ht@outlook.com"}"
LICENSE_PLAN="${LICENSE_PLAN:-ultimate}"
LICENSE_USER_COUNT="${LICENSE_USER_COUNT:-50}"
LICENSE_EXPIRE_YEAR="${LICENSE_EXPIRE_YEAR:-2045}"
set -e
